...
function resize(options) {
  ...
  var unsharpBlurRadius = typeof options.unsharpBlurRadius === 'undefined' ? 0 : (options.unsharpBlurRadius|0);
  ...
  if (unsharpAmount) {
    unsharp(dest, destW, destH, unsharpAmount, unsharpBlurRadius, unsharpThreshold);
  }
